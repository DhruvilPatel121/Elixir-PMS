...
function Timesheets() {
  ...
  const columns = [
    { id: 'member', label: 'Member', width: '1fr' },
    { id: 'project', label: 'Project', width: '1fr' },
    { id: 'client', label: 'Client', width: '1fr' },
    { id: 'task', label: 'Task', width: '1fr' },
    { id: 'startTime', label: 'Start time', width: '1fr' },
    { id: 'endTime', label: 'End time', width: '1fr' },
    { id: 'total', label: 'Total', width: '1fr' }
  ];
